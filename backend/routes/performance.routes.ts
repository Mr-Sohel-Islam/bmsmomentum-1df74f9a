...
router.post("/metrics", requireAuth, requirePermission("metrics:manage", "performance:manage"), asyncHandler(PerformanceController.createMetric));
router.put("/metrics/:id", requireAuth, requirePermission("metrics:manage", "performance:manage"), asyncHandler(PerformanceController.updateMetric));
router.delete("/metrics/:id", requireAuth, requirePermission("metrics:manage", "performance:manage"), asyncHandler(PerformanceController.deleteMetric));
